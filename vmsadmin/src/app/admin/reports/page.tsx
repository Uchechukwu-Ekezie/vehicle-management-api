        ...
        <CardContent className="pt-6">
          <div className="flex flex-col md:flex-row items-end gap-4">
            ...
            <Button
              ...
              className="h-12 bg-blue-600 hover:bg-blue-700 px-8 text-white"
            >
              Apply Filter
            </Button>
          </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <CardTitle className="text-gray-900">Fleet Overview</CardTitle>
              <Button onClick={exportFleetReport} variant="outline" className="text-gray-900">
                <svg
