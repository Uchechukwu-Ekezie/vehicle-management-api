  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-gray-900">Monthly Cost Trend</CardTitle>
          </CardHeader>
          <CardContent>
            {getCostByMonth().length > 0 ? (
              ...
              <div className="h-[300px] flex items-center justify-center text-[20px] text-gray-900">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-gray-900">Cost by Maintenance Type</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-gray-900">Cost Breakdown by Type</CardTitle>
        </CardHeader>
        <CardContent>
          {getCostByType().length > 0 ? (
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-gray-900">Top 5 Maintenance Expenses</CardTitle>
        </CardHeader>
        <CardContent>
